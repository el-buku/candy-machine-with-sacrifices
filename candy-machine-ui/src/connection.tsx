...
export const sendTransactions = async (
  ...
  // const parseSigners = (mintSigners: anchor.web3.Keypair[]) => {
  //   return mintSigners.map((kp: anchor.web3.Keypair) => ({
  //     publicKey: new anchor.web3.PublicKey(kp.publicKey.toBase58()),
  //     secretKey: kp.secretKey,
  //   }));
  // };
  //@ts-ignore
  window.debug = instructionSet[1];
  for (let i = 0; i < instructionSet.length; i++) {
    ...
    if (instructions.length > 0) {
      ...
      if (signers.length) {
        ...
        // console.log(...parseSigners(mintSigners));
